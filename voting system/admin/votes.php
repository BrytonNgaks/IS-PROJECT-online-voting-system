          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, candidates.firstname AS canfirst, candidates.lastname AS canlast, voters.lastname AS votlast FROM votes 
                    ...
                    while($row = $query->fetch_assoc()){
                      $timestamp = time();
                      $new_serial = sha1($timestamp . $row['votlast']); // Adjusted for available fields
